...
export class GraveForest extends Phaser.Scene {
    ...
    _attemptChop() {
        ...
        try {
            ...
            try { if (typeof window !== 'undefined' && window.__shared_ui && window.__shared_ui.debugTalent) console.debug('[graveForestChop] order',order,'dir',dir,'rowIndex',rowIndex); } catch(e){}
            if (framesPerRow > 0) {
    ...
    _startContinuousWoodcutting() {
        ...
        try {
            ...
            try { if (typeof window !== 'undefined' && window.__shared_ui && window.__shared_ui.debugTalent) console.debug('[graveForestStartWood] order',order2,'dir',dir,'rowIndex',rowIndex); } catch(e){}
            if (framesPerRow > 0) {
