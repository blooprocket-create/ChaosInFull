    ...
    try {
        ...
        for (const tid of nonStarTabs) {
            try {
                ...
                // advance baseline only by what we actually awarded to avoid overshooting on repeated calls or interleaved events
                char.talents._historicalBasePerTab[tid] = prevBase + toAward;
