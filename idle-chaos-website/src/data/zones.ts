...
export const zones: ZoneDefinition[] = [
  ...
  },
  {
    ...
    mobs: [],
    // Procedurally spawns from ORE_DEFS (tin, copper, iron, coal, mythril, gold, emerald, ruby, sapphire, opal, diamond)
    resources: [
      "Tin Ore",
      "Copper Ore",
      "Iron Ore",
  ...
  },
  {
    ...
    mobs: [],
    // Procedurally spawns from LOG_DEFS (normal, oak, pine, birch, maple)
    resources: [
      "Normal Log",
      "Oak Log",
      "Pine Log",
